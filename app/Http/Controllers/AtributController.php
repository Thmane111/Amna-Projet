...
class AtributController extends Controller
{
    ...
    public function index()
    {
        ...
        $user=Admin::all();
        return view('Espace-Admin.Attribution.index',compact('attribut','groupe','user','attribut_count','vv','modES'));
    }
    ...
    public function create()
    {
        ...
        return view('Espace-Admin.Attribution.add',compact('groupe','user'));
    }
