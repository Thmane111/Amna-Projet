    ...
    <nav class="navbar navbar-expand-lg  p-0">
        <div class="navbar-header  h-100 h4 mb-0 align-self-center logo-bar text-left">
            <a href="index.html" class="horizontal-logo text-left">
               <center> <strong> <h2>Amna.sn</h2></strong></center>
                ...
                </svg> <span class="h4 font-weight-bold align-self-center mb-0 ml-auto"><img src="" width=""></span>
            </a>
        </div>
            ...
            <ul class="ml-auto p-0 m-0 list-unstyled d-flex top-icon h-100">
                ...
                <li class="dropdown user-profile align-self-center d-inline-block">
                    <a href="#" class="nav-link py-0" data-toggle="dropdown" aria-expanded="false">
                        <div class="media">
                            <img src="/photo/profile/{{Auth::guard('admin')->user()->profile_photo_path}}" alt="" class="d-flex img-fluid rounded-circle" width="29">
                        </div>
                    </a>

                    <div class="dropdown-menu border dropdown-menu-right p-0">
                        <a href="" class="dropdown-item px-2 align-self-center d-flex">
                            <span class="icon-pencil mr-2 h6 mb-0"></span> Edit E-mail</a>
                        <a href="{{route('utilisateurs.show',Auth::guard('admin')->user()->id)}}" class="dropdown-item px-2 align-self-center d-flex">
                        ...
                        <form method="POST" action="{{route('admin.logout')}}">
                            @csrf
                        <a href="{{route('admin.logout')}}" onclick="event.preventDefault(), this.closest('form').submit();" class="dropdown-item px-2 text-danger align-self-center d-flex">
