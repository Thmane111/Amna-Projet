...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Liste des serie</a></li>
        </ol>
    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item state" href="#">@if($series->etat==0)
                                                    activer
                                                    @else desactiver
                                                    @endif
                                                   </a>
                            ...
                            @include('Back.serie.add')
@if( $serie_count!=0)
@include('Back.serie.edit')
@include('Back.serie.view')
@include('Back.serie.delete')
@include('Back.serie.state')
@endif
