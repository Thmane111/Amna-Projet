                      ...
                      <div class="card-body">
                          <div class="basic-form">
                              <form action="{{route('jury.import')}}" method="POST" enctype="multipart/form-data">
                                  ...
                                  <select class="default-select form-control wide mb-3" name="region_id" id="region">
                          ...
                          @endforeach
                                ...
                                <select class="default-select form-control wide mb-3" name="centre_id" id="centre">
                                    <option value="0"><u>Veuillez choire l'Utilisateur à attribuer</u></option>
                                    @foreach($region as $regions)
                                    <option value="{{$regions->id}}">{{$regions->Nom_Region}}</option>
                          @endforeach
