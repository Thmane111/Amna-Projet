...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Ajout une nouveau service</a></li>
        </ol>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Formulaire d'ajout d'un nouveau service</h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                 ...
                 @endif
                    <div class="basic-form">
                        <form class="form-valide-with-icon needs-validation" novalidate=""  method="POST" action="{{ route('service.store') }}" enctype="multipart/form-data">
                            @csrf

                            <div class="mb-3">
                            <div class="input-group">
                            <select class="default-select form-control wide mb-3" name="servicecategory">
                                <option value="0"><u>Veuillez choire un catégorie de service</u></option>
                      ...
                      @endforeach
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="service_titre"  id="validationCustomUsername" placeholder="titre" required="">
                                    @error('service_titre')
