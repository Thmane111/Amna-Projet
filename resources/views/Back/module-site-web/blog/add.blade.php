...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Ajout un nouveau blog</a></li>
        </ol>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Formulaire d'ajout d'un nouveau blog</h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                 ...
                 @endif
                    <div class="basic-form">
                        <form class="form-valide-with-icon needs-validation" novalidate=""  method="POST" action="{{ route('blog.StoreBlog') }}" enctype="multipart/form-data">
                            @csrf
                          ...
                          @endforeach
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="blog_titre"  id="validationCustomUsername" placeholder="titre" required="">
                                    @error('blog_titre')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="tag"  value="Home,tech" data-role="tagsinput"  >
