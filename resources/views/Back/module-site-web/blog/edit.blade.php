...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/admin/blog">liste des blogs</a></li>
            <li class="breadcrumb-item"><a href="#">Modifier un blog</a></li>
        </ol>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Formulaire de modification d'un nouveau blog</h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                 ...
                 @endif
                    <div class="basic-form">
                        <form class="form-valide-with-icon needs-validation" novalidate=""  method="POST" action="{{ route('blog.UpdateBlog',$modif->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="id" value="{{$modif->id}}">
                            <div class="mb-3">
                                <input type="hidden" name="blogcategory2" value="{{$modif->blog_category_id}}">
                            <div class="input-group">
                            <select class="default-select form-control wide mb-3" name="blogcategory">
                                <option value="0"><u>Veuillez choire un blog catégorie</u></option>
                                @foreach($blog as $blogs)
                                <option value="{{$blogs->id}}">{{$blogs->blog_category}}</option>
                      @endforeach
                            </select>
                            </div>
                            </div>
                            <input type="hidden" name="icon2" value="{{$modif->icon_id}}">
                            <div class="mb-3">
                                <div class="input-group">
                          ...
                          @endforeach
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    <span class="input-group-text">Titre du blog</span>
                                    <input type="text" class="form-control" value="{{$modif->blog_title}}" name="blog_titre"  id="validationCustomUsername" placeholder="titre" required="">
                                    @error('blog_titre')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Blog tags</span>
                                    <input type="text" class="form-control" name="tag"  value="{{$modif->blog_tag}}" data-role="tagsinput"  >
                                    ...
                                    <textarea  id="summernote" class="form-control" name="description" placeholder="Texte">
                                        {{$modif->blog_description}}
                                    </textarea>

                            <br>
                          <input type="hidden" name="image2" value="{{$modif->blog_image}}">
                            <div class="mb-3">
                                    <div class="c2" style="align-items: center;justify-content:center;border-radius:40px;">
                                        ...
                                        <div id="display-image" style="align-items: center;justify-content:center;text-align:center;border:solid 1px black;width:400px;height:200px">
                                          <img src="/photo/blog/{{$modif->blog_image}}" width="100%" height="100%">
                                        </div>
                                    </div>
