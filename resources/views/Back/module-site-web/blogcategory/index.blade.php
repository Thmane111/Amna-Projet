...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Liste des blog catégories</a></li>
        </ol>
    </div>
                        ...
                        <table class="table table-responsive-md">
                            <thead>
                                <tr>
                                    ...
                                    <th><strong>Nom blog categorie</strong></th>
...
<?php $comp=0; ?>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item state" href="#">@if($blogcategorys->etat==0)
                                                        activer
                                                        @else desactiver
                                                        @endif
                                                       </a>
                            ...
                            @include('Espace-Admin.module-site-web.blogcategory.add')
@if($blogcategory_count!=0)
@include('Espace-Admin.module-site-web.blogcategory.edit')
@include('Espace-Admin.module-site-web.blogcategory.view')
@include('Espace-Admin.module-site-web.blogcategory.delete')
@include('Espace-Admin.module-site-web.blogcategory.state')
@endif
