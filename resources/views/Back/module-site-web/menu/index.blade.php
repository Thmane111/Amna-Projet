...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Liste des menu</a></li>
        </ol>
    </div>
...
<?php $comp=0; ?>
                                ...
                                <tr>
                                    ...
                                    <td>{{$menus->nom}}</td>
                                    <td>{{$menus->url}}</td>
                                    <td style="display: none;">{{$menus->detail}}</td>
                                    <td>@if($menus->etat==0)
                                       ...
                                       <td style="display: none;">{{$menus->id}}</td>
                                       <td style="display: none;">{{$menus->parent}}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item state" href="#">@if($menus->etat==0)
                                                        activer
                                                        @else desactiver
                                                        @endif
                                                       </a>
                            ...
                            @include('Espace-Admin.module-site-web.menu.add')
@if( $menu_count!=0)
@include('Espace-Admin.module-site-web.menu.edit')
@include('Espace-Admin.module-site-web.menu.view')
@include('Espace-Admin.module-site-web.menu.delete')
@include('Espace-Admin.module-site-web.menu.state')
@endif
