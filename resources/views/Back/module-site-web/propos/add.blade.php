...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/admin/propos">Propos</a></li>
        </ol>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Formulaire d'ajout de propos</h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                 ...
                 @endif
                    <div class="basic-form">
                        <form class="form-valide-with-icon needs-validation" novalidate=""  method="POST" action="{{ route('propos.store') }}" enctype="multipart/form-data">
                            @csrf

                            <div class="mb-3">

                                <div class="input-group">
                                    <span class="input-group-text">Titre de propos</span>
                                    <input type="text" class="form-control" name="titre"  id="validationCustomUsername" placeholder="titre" required="">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Texte de propos</span>
                                    <textarea rows="8" id="ckeditor" class="form-control" name="texte" placeholder="Texte"></textarea>
                                    <div class="invalid-feedback">
