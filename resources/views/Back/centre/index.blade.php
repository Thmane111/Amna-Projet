                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item state" href="#">@if($centres->etat==0)
                                                    activer
                                                    @else desactiver
                                                    @endif
                                                   </a>
                            ...
                            @include('Back.centre.add')
@if( $centre_count!=0)
@include('Back.centre.edit')
@include('Back.centre.view')
@include('Back.centre.delete')
@include('Back.centre.state')
@endif
