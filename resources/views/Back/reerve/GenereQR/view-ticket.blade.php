...
<!DOCTYPE html>
<html lang="en" style="width:732px;display: flex; justify-content: center; align-items: center; height: 200px; margin: 0; background: #f0f0f0;">
<head>
    <meta charset="utf-8" />
    <meta
      name="viewport"
...
<body style="width:732px;display: flex; justify-content: center; align-items: center; height: 200px; margin: 0; background: #f0f0f0;">
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="width: 100%; background:black;justify-content:center;align-items:center;text-align: center;">
        <div class="row mb-5"  style="background:none;width:100%;justify-content: center;align-items:center;text-align:center;">
            <div class="col-md" style="background: none;width:100%;justify-content: center;align-items: center;text-align: center;justify-content: center;align-items: center;text-align: center;">
                <div class="card" style="background:none; justify-content: center; align-items: center; text-align: center;width:100%;height:200px;">
                    ...
                    <div class="row g-0" style="background-image: url({{ public_path('Affiche_Event/'.$donnees->event->image.'') }}); background-repeat: no-repeat; width:100%; background-size: cover; height:200px;">
                        <div class="col-md-1" id="QRC" style="width: 90px; height: 90px; justify-content: center; align-items: center; text-align: center; background:none;">
                            ...
                            <img src="{{ $qrCodes[$donnees->id] }}" alt="QR Code" style="width: 60px; height: 60px; margin-left:125px;; margin-top: 5%;">
