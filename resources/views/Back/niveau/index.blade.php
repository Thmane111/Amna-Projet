...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Liste des niveau</a></li>
        </ol>
    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item state" href="#">@if($niveaus->etat==0)
                                                    activer
                                                    @else desactiver
                                                    @endif
                                                   </a>
                            ...
                            @include('Back.niveau.add')
@if( $niveau_count!=0)
@include('Back.niveau.edit')
@include('Back.niveau.view')
@include('Back.niveau.delete')
@include('Back.niveau.state')
@endif
