...
<div class="container-fluid">
    ...
    @endif
                <form action="{{ route('eleve.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class="d-flex">
                    
                    <select class="col-3 form-control wide mb-3" id="region" name="region_id">
                        ...
                        <table id="example" class="display table dataTable table-striped table-bordered editable-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$eleves->CIN}}</td>
                                    <td class="fw-bold text-secondary">{{$eleves->Numero_Candidat}}</td>
                                    <td>{{$eleves->Prenom}} {{$eleves->Nom}}</td>
                                    <td>{{$eleves->Date_Naissance}}</td>
                                    <td>{{$eleves->Lieu_Naissance}}</td>
                                 
                                    <td>@if($eleves->etat==0)
                                        <span class="badge light badge-danger" style="font-size:15px; ">desactver</span>
                                        @elseif($eleves->etat==1)
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item state" href="#">@if($eleves->etat==0)
                                                    activer
                                                    @else desactiver
                                                    @endif
                                                   </a>
