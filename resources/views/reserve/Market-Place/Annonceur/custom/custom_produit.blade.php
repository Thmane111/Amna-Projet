...
<br>
                        ...
                        <div class="product-details-meta mb-20">
                            ...
                            <div class="d-flex align-items-center ">
                                ...
                                <div class="product-add-to-cart-btn">
                                    ...
                                    data-bs-toggle="modal"  data-bs-target="#modalAddcart"><img src="{{asset('/Market-Place/image/tel.jpg')}}" width="20px;"height="20px;" style="border-radius:20px;">  Téléphone</a>
                                </div>
                                <div class="product-add-to-cart-btn">
                                    <a href="https://web.whatsapp.com/send?phone=+22241176576&text=Test%20Link%20WhatsApp" class="btn btn-block btn-lg"
                                    ><img src="{{asset('/Market-Place/image/wt.png')}}" width="25px;"height="25px;">  watasapp</a>
                                </div>
                            </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    style="box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px;">
                                        ...
                                        <div class="tag" >
                                            ...
                                            <a href="{{route('Panel.show',$sous_prds->id)}}" class="image-link"
                                                        >
                                                        <?php

                                                        $img = ImageProduct::where('product_id', '=', $sous_prds->id)
                                                                        ->orderBy('id', 'desc')
                                                                        ->first();
                                                        ?>
    ...
    @include('Market-Place/custom/custom_contact');
