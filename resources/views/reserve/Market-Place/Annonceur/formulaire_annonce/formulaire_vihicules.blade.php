                        ...
                        <form id="msform" action="{{route('iss.AjoutProd')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    @foreach($cat_vih as $cat_vihs)


                                          <label class="option_item" style="width: 100px;">

                                            <input type="radio" style="width: 100px;" name="sous_cat" value="{{$cat_vihs->id}}"  class="checkbox" checked>
                                            <div class="option_inner facebook" style="width: 100px;border:solid 1px #A52A2A;">
                                              ...
                                              <i class="{{$cat_vihs->icon ? $cat_vihs->icon->nom_icon:''}}" style="font-size:25px;" aria-hidden="true"></i>
                                           </div>
                                              <div class="name" style="width:100px;"><p>{{$cat_vihs->nom_type}}</p></div>
                                            </div>
                                          </label>
