                    ...
                    <div class="siderbar-section" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div class="sidebar-single-widget">
                            ...
                            <div class="sidebar-content">
                                ...
                                <form method="GET" action="{{route('Panel.show_imm',00)}}"  enctype="multipart/form-data">
                                    @csrf
                                ...
                                <h6 class="sidebar-title">CATEGORIES</h6>
                                        ...
                                        <li>
                                            <label class="checkbox-default" for="brakeParts">
                                                <input type="checkbox" id="brakeParts" name="gorie_1" value="2" >
                                                <span>Villas(6)</span>
                                            </label>
                                        </li>
                                        ...
                                        <li>
                                            <label class="checkbox-default" for="accessories">
                                                <input type="checkbox" id="accessories" name="gorie_2"  value="3">
                                                <span>Terrains(10)</span>
                                            </label>
                                        </li>
                                        <li>
                                            <label class="checkbox-default" for="EngineParts">
                                                <input type="checkbox" id="EngineParts" name="gorie_3"  value="4">
                                                <span>Appartements(4)</span>
                                            </label>
                                        </li>
                                        <li>
                                            <label class="checkbox-default" for="hermes">
                                                <input type="checkbox" id="hermes" name="gorie_4" value="6">
                                                <span>Chambres(10)</span>
                                            </label>
                                        </li>

                                        <li>
                                            <label class="checkbox-default" for="hermes">
                                                <input type="checkbox" id="hermes" name="gorie_5" value="5">
                                                <span>Maison(10)</span>
                                            </label>
                                        </li>
                                ...
                                <div class="col-12">
                                    ...
                                    ">
                                        ...
                                        <?php
                                                     ...
                                                     $img=ImageProduct::all()->where('product_id','=',$globe_cats->id);
                                                     ?>
                                                       @foreach($img as $imgs)
