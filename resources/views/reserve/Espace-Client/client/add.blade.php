          ...
          <div class="card card-outline">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="telephone" id="exampleInputEmail1"  placeholder="Téléphone">
              </div>

              <div class="form-group">
                
                <input type="text" class="form-control" name="entreprise" id="exampleInputEmail1"  placeholder="entreprises">
              </div>
