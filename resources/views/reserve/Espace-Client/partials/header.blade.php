        ...
        <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
            <div class="d-flex">
                <a class="nav-link text-primary collapsed" href="help.html" title="Get Help">
                    <i class="icofont-email fs-5"></i><strong>D-tic12@gmail.com </strong>
                </a>

            </div>
            <div class="d-flex">
                <a class="nav-link text-primary collapsed" href="help.html" title="Get Help">
                    <i class="icofont-phone fs-5"></i><strong>Nous contactez directement </strong>
                </a>
            ...
            <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                <div class="u-info me-2">
                    <p class="mb-0 text-end line-height-sm "><span class="font-weight-bold">{{Auth::user()->name}}{{' '}}{{Auth::user()->prenom}}</span></p>
                    ...
                    <div class="card border-0 w280">
                        ...
                        <div class="list-group m-2 ">
                            ...
                            <form method="POST" action="{{route('app.logout')}}">
                                @csrf
                            <a  href="{{route('app.logout')}}" onclick="event.preventDefault(), this.closest('form').submit();" class="list-group-item list-group-item-action border-0 "><i class="icofont-logout fs-6 me-3"></i>Signout</a>
                        </form>
                            <div><hr class="dropdown-divider border-dark"></div>
